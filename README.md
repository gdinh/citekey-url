...
This also adds a right-click menu item to copy a URL of this form.
...
There is no configuration interface. If you'd like to change the URL scheme, change the line
